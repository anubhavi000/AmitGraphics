          ...
          <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
              <div class="navbar-logo">
                <a href="index.html">
                  <img class="img-fluid" src="{{asset('theme/assets/images/logo.png')}}" alt="Theme-Logo">
                </a>
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{asset('index.html" class="waves-effect waves-dark">
                      ...
                      <span class="pcoded-micon">
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                    <span class="pcoded-mtext">Layout</span>
                                </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            ...
                                            <span class="pcoded-mtext">                                                 
                                                <form action="" method="GET">
                                                    <button name="vertical" value="vertical">vertical </button>
                                                </form>
                                            </span>
                                        </a>
                                        </li>
                                        <li class="">
                                            ...
                                            <span class="pcoded-mtext">
                                                <form action="" method="GET">
                                                <button name="horizontal" value="horizontal">horizontal </button>
                                                </form>
                                            </span>
                                        </a>
                                        </li>

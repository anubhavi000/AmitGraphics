...
.fnt{
  ...
  <body style="background: #f3f3f3">
    <div class="container-fluid" style="padding: 10px;">
     ...
     <div class="col-md-6">
      <h3 class="content-header-title mb-0">Department Details</h3>
       <p class="syn_font"><i class="fas fa-inr"></i>Department ID: <strong style="font-weight: bolder;">{{$department->id}}</strong></p> 
     </div>
    ...
    <div class="row">
      <div class="col-md-4 ">
      <p class="syn_font text-center " style="margin-bottom:0px"> <strong style="font-weight: bolder; ">{{$department->id}}</strong></p> 
...
<div class="col-md-3">
 ...
 <p>{{!empty($department->description)?$department->description:'---'}} </p>
</div>
 ...
 <p>{{!empty($department->created_at)?$department->created_at:'---'}} </p>
</div>
  <div class="col-md-3">
 <h6 class="fnt">Created By</h6>
 <p>{{!empty($department->created_by)?$department->created_by:'---'}} </p>
</div>
    </div>
